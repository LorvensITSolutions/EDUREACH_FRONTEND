...
const IncomeExpenseChart = ({ data, loading }) => {
  ...
  // Create sample data for the last 10 days if no data is available
  const chartData = data && data.length > 0 ? data : [
    { day: '20-Sep', income: 0, expense: 0 },
    { day: '21-Sep', income: 0, expense: 0 },
    { day: '22-Sep', income: 0, expense: 0 },
    { day: '23-Sep', income: 0, expense: 0 },
    { day: '24-Sep', income: 0, expense: 0 },
    { day: '25-Sep', income: 60000, expense: 0 },
    { day: '26-Sep', income: 0, expense: 0 },
    { day: '27-Sep', income: 0, expense: 0 },
    { day: '28-Sep', income: 0, expense: 0 },
    { day: '29-Sep', income: 0, expense: 0 }
  ];
...
// Main Simple Dashboard Component
